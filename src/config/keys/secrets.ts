...
export class _Secrets {
  ...
  static JWT_OTP_KEY = process.env.JWT_OTP_KEY as string;
  ...
  static EMAIL_ADDRESS = process.env.EMAIL_ADDRESS as string;
  static EMAIL_PASSWORD = process.env.EMAIL_PASSWORD as string;
}
